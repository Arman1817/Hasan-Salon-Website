...
String name, phone, eml, mess, time, lname;
            name = request.getParameter("first_name");
            lname= request.getParameter("lst_name");
            phone = request.getParameter("phone");
            eml = request.getParameter("email");
            mess = request.getParameter("comments");
            time = request.getParameter("select_service");
           ...
           MongoClient mongoClient = new MongoClient("localhost", 27017);
                ...
                out.println("<h2> Appointment Booked Successfull.....</h2>"); 
